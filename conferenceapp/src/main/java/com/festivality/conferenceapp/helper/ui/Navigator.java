...
public interface Navigator {
    ...
    void startActivity(@NonNull Class<? extends Activity> var1, @NonNull PlainConsumer<Intent> var2);
    ...
    void startActivityWithTransition(@NonNull Class<? extends Activity> var1, @NonNull PlainConsumer<Intent> var2, boolean var3, boolean var4, View... var5);

    void startActivityForResult(@NonNull Class<? extends Activity> var1, int var2);

    void startActivityForResult(@NonNull Class<? extends Activity> var1, @NonNull PlainConsumer<Intent> var2, int var3);
